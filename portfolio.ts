...
export const greetings: GreetingsType = {
  ...
  description: `Sou bonitinha / Web Developer com mais de quatro anos de experiência em construir aplicações. Tenho experiência em aplicações web com React, Vue, Angular, Next.js, Nuxt.js, Node.js e Java.`,
  resumeLink:
